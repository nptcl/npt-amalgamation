...
{ CONSTANT_CODE_EXECUTE_CONTROL_SET, CODE, "EXECUTE-CONTROL-SET", 19, 0x5A91A3A797E7ECEEULL, 0, 0, 0 },
{ CONSTANT_CODE_EXECUTE_CONTROL_PUSH, CODE, "EXECUTE-CONTROL-PUSH", 20, 0x5A91A3A7DFE6FCECULL, 0, 0, 0 },
{ CONSTANT_CODE_EXECUTE_CONTROL_SAVE, CODE, "EXECUTE-CONTROL-SAVE", 20, 0x5A91A3A7DCE9E8EFULL, 0, 0, 0 },
...
{ CONSTANT_CODE_UNWIND_PROTECT, CODE, "UNWIND-PROTECT", 14, 0x502D98918EAB9DB5ULL, 0, 0, 0 },
...
{ CONSTANT_CODE_REST, CODE, "REST", 4, 0x0000000054534556ULL, 0, 0, 0 },
...
{ CONSTANT_SYSTEM_QUESTION, SYSTEM, "QUESTION", 8, 0x4E4F495453455559ULL, 0, 1, 0 },
{ CONSTANT_SYSTEM_EXTENSION, SYSTEM, "EXTENSION", 9, 0x4F49534E4554589CULL, 0, 1, 0 },
...
{ CONSTANT_SYSTEM_STEP_PARSE, SYSTEM, "*STEP-PARSE*", 12, 0x41502D506F99A688ULL, 1, 0, 0 },
{ CONSTANT_SYSTEM_STEP_BREAK, SYSTEM, "*STEP-BREAK*", 12, 0x52422D506F9F947BULL, 1, 0, 0 },
{ CONSTANT_SYSTEM_STEP_VALUE, SYSTEM, "*STEP-VALUE*", 12, 0x41562D506F99A882ULL, 1, 0, 0 },
...
{ CONSTANT_SYSTEM_TERME, SYSTEM, "*TERME*", 7, 0x002A454D52455431ULL, 1, 0, 0 },
...
{ CONSTANT_CODE_EXECUTE_CONTROL_SET, CODE, "EXECUTE-CONTROL-SET", 19, 0x72799095ULL, 0, 0, 0 },
{ CONSTANT_CODE_EXECUTE_CONTROL_PUSH, CODE, "EXECUTE-CONTROL-PUSH", 20, 0x3A78A093ULL, 0, 0, 0 },
{ CONSTANT_CODE_EXECUTE_CONTROL_SAVE, CODE, "EXECUTE-CONTROL-SAVE", 20, 0x377B8C96ULL, 0, 0, 0 },
...
{ CONSTANT_CODE_UNWIND_PROTECT, CODE, "UNWIND-PROTECT", 14, 0x5ED93646ULL, 0, 0, 0 },
...
{ CONSTANT_SYSTEM_TERME, SYSTEM, "*TERME*", 7, 0x526F997EULL, 1, 0, 0 },
		...
		addr *ret, addr cons, addr instance, addr defvalue)
{
	...
	addr whole, env, temp, symbol, init, sup, base;
